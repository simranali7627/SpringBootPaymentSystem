...
public class VendorController {
    ...
    public ResponseEntity<String> transferMoney(
        ...
        vendor.getStoreWallet().setwalletBalance(vendor.getStoreWallet().getwalletBalance() - amount);
        vendor.getPersonalWallet().setwalletBalance(vendor.getPersonalWallet().getWalletId() + amount);
